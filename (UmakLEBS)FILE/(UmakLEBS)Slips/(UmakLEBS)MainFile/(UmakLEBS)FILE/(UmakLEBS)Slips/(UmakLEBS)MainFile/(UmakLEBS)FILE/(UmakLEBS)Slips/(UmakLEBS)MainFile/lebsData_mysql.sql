...
CREATE TABLE admins (
        admin_id INT AUTO_INCREMENT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE history (
        transaction_id INT AUTO_INCREMENT PRIMARY KEY AUTO_INCREMENT,
        equipment_no TEXT,
        name TEXT,
        borrower TEXT,
        borrow_date TEXT,
...
CREATE TABLE inventory (
        item_id INT AUTO_INCREMENT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE transactions (
        borrow_id INT AUTO_INCREMENT PRIMARY KEY AUTO_INCREMENT,
        user_id INTEGER NOT NULL,
...
DELETE FROM "INSERT INTO "INSERT INTO "INSERT INTO "INSERT INTO "INSERT INTO "INSERT INTO "